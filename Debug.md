...
To simulate your application with Questasim using the remote_bitbang server, you need to compile you system adding the following FuseSoC parameter:

```
make verilator-sim FUSESOC_FLAGS="--JTAG_DPI=1"
```
...
```
make questasim-sim FUSESOC_FLAGS="--JTAG_DPI=1"
```
