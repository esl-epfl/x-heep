...
MEMORY
{
  /* Our testbench is a bit weird in that we initialize the RAM (thus
     ...
     sections to ram. */
  ram0 (rwxai) : ORIGIN = 0x${linker_onchip_code_start_address}, LENGTH = 0x${linker_onchip_code_size_address} + 0x2200
  ram1 (rwxai) : ORIGIN = 0x${linker_onchip_data_start_address} + 0x2200, LENGTH = 0x${linker_onchip_data_size_address}
}
