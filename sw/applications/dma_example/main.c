...
int main(int argc, char *argv[])
{
    ...
    uint32_t copied_data_4B_ADDR_MODE[2*TEST_DATA_SIZE] __attribute__ ((aligned (4))) = { 0 };
     // this array will contain the even address of copied_data_4B_ADDR_MODE
    uint32_t test_addr_4B_PTR[TEST_DATA_SIZE] __attribute__ ((aligned (4))) = { 0 };
...
#pragma message ( "this application should not be ran in a system integrating x-heep as in the external \
    ...
    test_addr_4B_PTR = EXT_SLAVE_START_ADDRESS;
    copied_data_4B_ADDR_MODE = &test_addr_4B_PTR[TEST_DATA_SIZE+1];
