...
uint32_t __attribute__((section(".xheep_data_flash_only"))) r_data[2] = {
    0x76543211, 0xfedcba99
};
// uint32_t r_data[256] = {
...
// REQUIRES QUESTASIM?
// HENCE RUN SIMULATION ON SERVER, GET RID OF BUILD/ IN GITIGNORE
// IMPORT LOCALLY WAVEFORMS AND FINALLY VISUALIZE?