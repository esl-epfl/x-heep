...
__attribute__ ((optimize("O0"))) void waiting_for_spc_irq( void )
{
  ...
  while (im2col_done == 0)
  {
    // Insert traffic on the AOPB to test bugs
    *(volatile uint32_t *) (trash_peri + DMA_SRC_PTR_INC_D1_REG_OFFSET) = 0;
    
    *(volatile uint32_t *) (trash_peri + DMA_SRC_PTR_INC_D2_REG_OFFSET) = 0;

    *(volatile uint32_t *) (trash_peri + DMA_DST_PTR_INC_D1_REG_OFFSET) = 0;
    
    *(volatile uint32_t *) (trash_peri + DMA_DST_PTR_INC_D2_REG_OFFSET) = 0;
    
    *(volatile uint32_t *) (trash_peri + DMA_SRC_PTR_INC_D1_REG_OFFSET) = 1;
    
    *(volatile uint32_t *) (trash_peri + DMA_SRC_PTR_INC_D2_REG_OFFSET) = 1;

    *(volatile uint32_t *) (trash_peri + DMA_DST_PTR_INC_D1_REG_OFFSET) = 1;
    
    *(volatile uint32_t *) (trash_peri + DMA_DST_PTR_INC_D2_REG_OFFSET) = 1;
    
    *(volatile uint32_t *) (trash_peri + DMA_SRC_PTR_INC_D1_REG_OFFSET) = 2;
    
    *(volatile uint32_t *) (trash_peri + DMA_SRC_PTR_INC_D2_REG_OFFSET) = 2;

    *(volatile uint32_t *) (trash_peri + DMA_DST_PTR_INC_D1_REG_OFFSET) = 2;
    
    *(volatile uint32_t *) (trash_peri + DMA_DST_PTR_INC_D2_REG_OFFSET) = 2;
    
    *(volatile uint32_t *) (trash_peri + DMA_SRC_PTR_INC_D1_REG_OFFSET) = 3;
    
    *(volatile uint32_t *) (trash_peri + DMA_SRC_PTR_INC_D2_REG_OFFSET) = 3;

    *(volatile uint32_t *) (trash_peri + DMA_DST_PTR_INC_D1_REG_OFFSET) = 3;
    
    *(volatile uint32_t *) (trash_peri + DMA_DST_PTR_INC_D2_REG_OFFSET) = 3;
