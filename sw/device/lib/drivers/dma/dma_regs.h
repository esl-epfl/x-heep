...
#define DMA_SIZE_REG_OFFSET 0x8

// Status bits are set to one if a given event occurred
#define DMA_STATUS_REG_OFFSET 0xc
...
#define DMA_PTR_INC_REG_OFFSET 0x10
...
#define DMA_SLOT_REG_OFFSET 0x14
...
#define DMA_DATA_TYPE_REG_OFFSET 0x18
