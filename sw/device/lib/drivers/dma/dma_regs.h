...
#define DMA_SIZE_IN_REG_OFFSET 0x14
#define DMA_SIZE_IN_D1_MASK 0xffff
#define DMA_SIZE_IN_D1_OFFSET 0
#define DMA_SIZE_IN_D1_FIELD \
  ((bitfield_field32_t) { .mask = DMA_SIZE_IN_D1_MASK, .index = DMA_SIZE_IN_D1_OFFSET })
#define DMA_SIZE_IN_D2_MASK 0xffff
#define DMA_SIZE_IN_D2_OFFSET 16
#define DMA_SIZE_IN_D2_FIELD \
  ((bitfield_field32_t) { .mask = DMA_SIZE_IN_D2_MASK, .index = DMA_SIZE_IN_D2_OFFSET })

// Status bits are set to one if a given event occurred
#define DMA_STATUS_REG_OFFSET 0x18
...
#define DMA_SRC_PTR_INC_REG_OFFSET 0x1c
#define DMA_SRC_PTR_INC_SRC_PTR_INC_D1_MASK 0xff
...
#define DMA_SRC_PTR_INC_SRC_PTR_INC_D2_MASK 0xffff
#define DMA_SRC_PTR_INC_SRC_PTR_INC_D2_OFFSET 8
...
// Increment number of src/dst pointer every time a word is copied
#define DMA_DST_PTR_INC_REG_OFFSET 0x20
#define DMA_DST_PTR_INC_DST_PTR_INC_D1_MASK 0xff
...
#define DMA_DST_PTR_INC_DST_PTR_INC_D2_MASK 0xffff
#define DMA_DST_PTR_INC_DST_PTR_INC_D2_OFFSET 8
...
#define DMA_SLOT_REG_OFFSET 0x24
...
#define DMA_DATA_TYPE_REG_OFFSET 0x28
...
#define DMA_MODE_REG_OFFSET 0x2c
...
#define DMA_DIM_CONFIG_REG_OFFSET 0x30
#define DMA_DIM_CONFIG_DMA_DIM_BIT 0

// Set the padding options
#define DMA_PAD_REG_OFFSET 0x34
#define DMA_PAD_LEFT_PAD_MASK 0xff
...
#define DMA_WINDOW_SIZE_REG_OFFSET 0x38

// Number of times the end of the window was reached since the beginning.
#define DMA_WINDOW_COUNT_REG_OFFSET 0x3c

// Interrupt Enable Register
#define DMA_INTERRUPT_EN_REG_OFFSET 0x40
