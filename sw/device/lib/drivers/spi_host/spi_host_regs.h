...
#define SPI_HOST_COMMAND_LEN_MASK 0xffff
...
#define SPI_HOST_COMMAND_CSAAT_BIT 16
#define SPI_HOST_COMMAND_SPEED_MASK 0x3
#define SPI_HOST_COMMAND_SPEED_OFFSET 17
...
#define SPI_HOST_COMMAND_DIRECTION_OFFSET 19
