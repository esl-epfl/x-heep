 ...
 */
MMIO_WARN_UNUSED_RESULT
static inline uint32_t mmio_region_read32(mmio_region_t base, ptrdiff_t offset) {
...
MMIO_WARN_UNUSED_RESULT
MMIO_DEPRECATED
static inline uint32_t mmio_region_read_mask32(mmio_region_t base, ptrdiff_t offset,
