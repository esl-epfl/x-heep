...
#define BOOTROM_START_ADDRESS (PERIPHERAL_START_ADDRESS + 0x0020000)
#define BOOTROM_SIZE 0x0000100
#define BOOTROM_END_ADDRESS (BOOTROM_START_ADDRESS + BOOTROM_SIZE)

#define EXT_PERIPHERAL_START_ADDRESS (PERIPHERAL_START_ADDRESS + 0x0030000)
