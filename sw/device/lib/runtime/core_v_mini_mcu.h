...
#define SPI_HOST_START_ADDRESS (AO_PERIPHERAL_START_ADDRESS + 0x00020000)
#define SPI_HOST_SIZE 0x00008000
...
#define POWER_MANAGER_START_ADDRESS (AO_PERIPHERAL_START_ADDRESS + 0x00030000)
#define POWER_MANAGER_SIZE 0x00010000
#define POWER_MANAGER_END_ADDRESS (POWER_MANAGER_START_ADDRESS + POWER_MANAGER_SIZE)

#define RV_TIMER_START_ADDRESS (AO_PERIPHERAL_START_ADDRESS + 0x00040000)
...
#define PLIC_START_ADDRESS (PERIPHERAL_START_ADDRESS + 0x00000000)
#define PLIC_SIZE 0x00010000
#define PLIC_END_ADDRESS (PLIC_START_ADDRESS + PLIC_SIZE)

#define UART_START_ADDRESS (PERIPHERAL_START_ADDRESS + 0x00010000)
...
#define EXT_PERIPHERAL_START_ADDRESS (PERIPHERAL_START_ADDRESS + 0x00030000)
