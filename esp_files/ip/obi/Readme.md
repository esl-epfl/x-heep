...
- `ObiCfg`: This specifies the configuration used for the OBI protocol being input or output from the link. A default config can be found in the `obi_pkg_ip.sv`. This config should be aligned with the `req` and `rsp` structs.
