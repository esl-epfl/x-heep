...
set_property -dict {PACKAGE_PIN L13 IOSTANDARD LVCMOS18} [get_ports {gpio_io[11]}]
set_property -dict {PACKAGE_PIN Y9 IOSTANDARD LVCMOS18} [get_ports {gpio_io[12]}]
set_property -dict {PACKAGE_PIN Y10 IOSTANDARD LVCMOS18} [get_ports {gpio_io[13]}]
set_property -dict {PACKAGE_PIN AB5 IOSTANDARD LVCMOS18} [get_ports {gpio_io[14]}]
set_property -dict {PACKAGE_PIN AB6 IOSTANDARD LVCMOS18} [get_ports {gpio_io[15]}]
set_property -dict {PACKAGE_PIN U4 IOSTANDARD LVCMOS18} [get_ports {gpio_io[16]}]
set_property -dict {PACKAGE_PIN U5 IOSTANDARD LVCMOS18} [get_ports {gpio_io[17]}]
