...
#(
  ...
  inout wire logic                           pad_xheep_pad_io_23_pad,
  inout wire logic                           pad_xheep_pad_io_24_pad,
  inout wire logic                           pad_xheep_pad_io_25_pad,
  inout wire logic                           pad_xheep_pad_io_26_pad,
  inout wire logic                           pad_xheep_pad_io_27_pad,
  inout wire logic                           pad_xheep_pad_io_28_pad,
  inout wire logic                           pad_xheep_pad_io_29_pad,
  ...
  padframe_xheep #(
   ...
   .pad_pad_io_24_pad(pad_xheep_pad_io_24_pad),
   .pad_pad_io_25_pad(pad_xheep_pad_io_25_pad),
   .pad_pad_io_26_pad(pad_xheep_pad_io_26_pad),
   .pad_pad_io_27_pad(pad_xheep_pad_io_27_pad),
   .pad_pad_io_28_pad(pad_xheep_pad_io_28_pad),
   .pad_pad_io_29_pad(pad_xheep_pad_io_29_pad),
   ...
   localparam addr_rule_t[NUM_PAD_DOMAINS-1:0] ADDR_DEMUX_RULES = '{
     '{ idx: 0, start_addr: 7'd0,  end_addr: 7'd76}
     };
