...
% endfor
    ...
    .ext_slave_core_instr_req_o,
    .ext_slave_core_instr_resp_i,
    .ext_slave_core_data_req_o,
    .ext_slave_core_data_resp_i,
    .ext_slave_debug_master_req_o,
    .ext_slave_debug_master_resp_i,
    .ext_slave_dma_master0_ch0_req_o,
    .ext_slave_dma_master0_ch0_resp_i,
    .ext_slave_dma_master1_ch0_req_o,
    .ext_slave_dma_master1_ch0_resp_i,
