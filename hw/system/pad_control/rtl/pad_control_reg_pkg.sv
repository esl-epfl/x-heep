...
package pad_control_reg_pkg;
  ...
  // Register offsets
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_CLK_OFFSET = 8'h0;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_RST_OFFSET = 8'h4;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_BOOT_SELECT_OFFSET = 8'h8;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_EXECUTE_FROM_FLASH_OFFSET = 8'hc;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TCK_OFFSET = 8'h10;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TMS_OFFSET = 8'h14;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TRST_OFFSET = 8'h18;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TDI_OFFSET = 8'h1c;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TDO_OFFSET = 8'h20;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_UART_RX_OFFSET = 8'h24;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_UART_TX_OFFSET = 8'h28;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_EXIT_VALID_OFFSET = 8'h2c;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_0_OFFSET = 8'h30;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_1_OFFSET = 8'h34;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_2_OFFSET = 8'h38;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_3_OFFSET = 8'h3c;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_4_OFFSET = 8'h40;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_5_OFFSET = 8'h44;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_6_OFFSET = 8'h48;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_7_OFFSET = 8'h4c;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_8_OFFSET = 8'h50;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_9_OFFSET = 8'h54;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_10_OFFSET = 8'h58;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_11_OFFSET = 8'h5c;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_12_OFFSET = 8'h60;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_13_OFFSET = 8'h64;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_14_OFFSET = 8'h68;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_15_OFFSET = 8'h6c;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_16_OFFSET = 8'h70;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_17_OFFSET = 8'h74;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_18_OFFSET = 8'h78;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_19_OFFSET = 8'h7c;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_20_OFFSET = 8'h80;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_21_OFFSET = 8'h84;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_22_OFFSET = 8'h88;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_23_OFFSET = 8'h8c;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_24_OFFSET = 8'h90;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_25_OFFSET = 8'h94;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_26_OFFSET = 8'h98;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_27_OFFSET = 8'h9c;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_28_OFFSET = 8'ha0;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_29_OFFSET = 8'ha4;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_30_OFFSET = 8'ha8;
  parameter logic [BlockAw-1:0] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_31_OFFSET = 8'hac;
  ...
  parameter logic [3:0] PAD_CONTROL_PERMIT[60] = '{
      4'b0001,  // index[ 0] PAD_CONTROL_PAD_ATTRIBUTE_CLK
      4'b0001,  // index[ 1] PAD_CONTROL_PAD_ATTRIBUTE_RST
      4'b0001,  // index[ 2] PAD_CONTROL_PAD_ATTRIBUTE_BOOT_SELECT
      4'b0001,  // index[ 3] PAD_CONTROL_PAD_ATTRIBUTE_EXECUTE_FROM_FLASH
      4'b0001,  // index[ 4] PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TCK
      4'b0001,  // index[ 5] PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TMS
      4'b0001,  // index[ 6] PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TRST
      4'b0001,  // index[ 7] PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TDI
      4'b0001,  // index[ 8] PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TDO
      4'b0001,  // index[ 9] PAD_CONTROL_PAD_ATTRIBUTE_UART_RX
      4'b0001,  // index[10] PAD_CONTROL_PAD_ATTRIBUTE_UART_TX
      4'b0001,  // index[11] PAD_CONTROL_PAD_ATTRIBUTE_EXIT_VALID
      4'b0001,  // index[12] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_0
      4'b0001,  // index[13] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_1
      4'b0001,  // index[14] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_2
      4'b0001,  // index[15] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_3
      4'b0001,  // index[16] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_4
      4'b0001,  // index[17] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_5
      4'b0001,  // index[18] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_6
      4'b0001,  // index[19] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_7
      4'b0001,  // index[20] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_8
      4'b0001,  // index[21] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_9
      4'b0001,  // index[22] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_10
      4'b0001,  // index[23] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_11
      4'b0001,  // index[24] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_12
      4'b0001,  // index[25] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_13
      4'b0001,  // index[26] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_14
      4'b0001,  // index[27] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_15
      4'b0001,  // index[28] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_16
      4'b0001,  // index[29] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_17
      4'b0001,  // index[30] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_18
      4'b0001,  // index[31] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_19
      4'b0001,  // index[32] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_20
      4'b0001,  // index[33] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_21
      4'b0001,  // index[34] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_22
      4'b0001,  // index[35] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_23
      4'b0001,  // index[36] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_24
      4'b0001,  // index[37] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_25
      4'b0001,  // index[38] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_26
      4'b0001,  // index[39] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_27
      4'b0001,  // index[40] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_28
      4'b0001,  // index[41] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_29
      4'b0001,  // index[42] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_30
      4'b0001,  // index[43] PAD_CONTROL_PAD_ATTRIBUTE_GPIO_31
