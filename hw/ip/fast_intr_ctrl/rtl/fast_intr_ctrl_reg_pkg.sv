...
package fast_intr_ctrl_reg_pkg;
  ...
  typedef struct packed {
    logic [15:0] q;
  } fast_intr_ctrl_reg2hw_fast_intr_enable_reg_t;
  ...
  // Register offsets
  parameter logic [BlockAw-1:0] FAST_INTR_CTRL_FAST_INTR_PENDING_OFFSET = 4'h 0;
  parameter logic [BlockAw-1:0] FAST_INTR_CTRL_FAST_INTR_CLEAR_OFFSET = 4'h 4;
  parameter logic [BlockAw-1:0] FAST_INTR_CTRL_FAST_INTR_ENABLE_OFFSET = 4'h 8;
  ...
  parameter logic [3:0] FAST_INTR_CTRL_PERMIT [3] = '{
    4'b 0011, // index[0] FAST_INTR_CTRL_FAST_INTR_PENDING
    4'b 0011, // index[1] FAST_INTR_CTRL_FAST_INTR_CLEAR
    4'b 0011  // index[2] FAST_INTR_CTRL_FAST_INTR_ENABLE
  };
