...
package serial_link_single_channel_reg_pkg;
  ...
  typedef struct packed {logic q;} serial_link_single_channel_reg2hw_raw_mode_in_ch_sel_reg_t;
  ...
  typedef struct packed {logic q;} serial_link_single_channel_reg2hw_raw_mode_out_ch_mask_reg_t;
  ...
  typedef struct packed {logic q;} serial_link_single_channel_reg2hw_raw_mode_out_en_reg_t;
  ...
  typedef struct packed {logic d;} serial_link_single_channel_hw2reg_raw_mode_in_data_valid_reg_t;

  typedef struct packed {logic [15:0] d;} serial_link_single_channel_hw2reg_raw_mode_in_data_reg_t;
  ...
  // Register offsets
  parameter logic [BlockAw-1:0] SERIAL_LINK_SINGLE_CHANNEL_CTRL_OFFSET = 6'h0;
  parameter logic [BlockAw-1:0] SERIAL_LINK_SINGLE_CHANNEL_ISOLATED_OFFSET = 6'h4;
  parameter logic [BlockAw-1:0] SERIAL_LINK_SINGLE_CHANNEL_TX_PHY_CLK_DIV_OFFSET = 6'h8;
  parameter logic [BlockAw-1:0] SERIAL_LINK_SINGLE_CHANNEL_TX_PHY_CLK_START_OFFSET = 6'hc;
  parameter logic [BlockAw-1:0] SERIAL_LINK_SINGLE_CHANNEL_TX_PHY_CLK_END_OFFSET = 6'h10;
  parameter logic [BlockAw-1:0] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_EN_OFFSET = 6'h14;
  parameter logic [BlockAw-1:0] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_IN_CH_SEL_OFFSET = 6'h18;
  parameter logic [BlockAw-1:0] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_IN_DATA_VALID_OFFSET = 6'h1c;
  parameter logic [BlockAw-1:0] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_IN_DATA_OFFSET = 6'h20;
  parameter logic [BlockAw-1:0] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_OUT_CH_MASK_OFFSET = 6'h24;
  parameter logic [BlockAw-1:0] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_OUT_DATA_FIFO_OFFSET = 6'h28;
  parameter logic [BlockAw-1:0] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_OUT_DATA_FIFO_CTRL_OFFSET = 6'h 2c;
  parameter logic [BlockAw-1:0] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_OUT_EN_OFFSET = 6'h30;
  parameter logic [BlockAw-1:0] SERIAL_LINK_SINGLE_CHANNEL_FLOW_CONTROL_FIFO_CLEAR_OFFSET = 6'h34;

  // Reset values for hwext registers and their fields
  parameter logic [1:0] SERIAL_LINK_SINGLE_CHANNEL_ISOLATED_RESVAL = 2'h3;
  parameter logic [0:0] SERIAL_LINK_SINGLE_CHANNEL_ISOLATED_AXI_IN_RESVAL = 1'h1;
  parameter logic [0:0] SERIAL_LINK_SINGLE_CHANNEL_ISOLATED_AXI_OUT_RESVAL = 1'h1;
  parameter logic [0:0] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_IN_DATA_VALID_RESVAL = 1'h0;
  parameter logic [15:0] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_IN_DATA_RESVAL = 16'h0;
  parameter logic [31:0] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_OUT_DATA_FIFO_CTRL_RESVAL = 32'h0;
  ...
  parameter logic [0:0] SERIAL_LINK_SINGLE_CHANNEL_FLOW_CONTROL_FIFO_CLEAR_RESVAL = 1'h0;
  ...
  parameter logic [3:0] SERIAL_LINK_SINGLE_CHANNEL_PERMIT[14] = '{
      4'b0011,  // index[ 0] SERIAL_LINK_SINGLE_CHANNEL_CTRL
      4'b0001,  // index[ 1] SERIAL_LINK_SINGLE_CHANNEL_ISOLATED
      4'b0011,  // index[ 2] SERIAL_LINK_SINGLE_CHANNEL_TX_PHY_CLK_DIV
      4'b0011,  // index[ 3] SERIAL_LINK_SINGLE_CHANNEL_TX_PHY_CLK_START
      4'b0011,  // index[ 4] SERIAL_LINK_SINGLE_CHANNEL_TX_PHY_CLK_END
      4'b0001,  // index[ 5] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_EN
      4'b0001,  // index[ 6] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_IN_CH_SEL
      4'b0001,  // index[ 7] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_IN_DATA_VALID
      4'b0011,  // index[ 8] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_IN_DATA
      4'b0001,  // index[ 9] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_OUT_CH_MASK
      4'b0011,  // index[10] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_OUT_DATA_FIFO
      4'b1111,  // index[11] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_OUT_DATA_FIFO_CTRL
      4'b0001,  // index[12] SERIAL_LINK_SINGLE_CHANNEL_RAW_MODE_OUT_EN
      4'b0001  // index[13] SERIAL_LINK_SINGLE_CHANNEL_FLOW_CONTROL_FIFO_CLEAR
  };
