...
module i2s_reg_top #(
  ...
  logic cfg_flush_fifo_qs;
  logic cfg_flush_fifo_wd;
  logic cfg_flush_fifo_we;
  ...
  prim_subreg #(
    ...
    // from register interface
    .we     (cfg_flush_fifo_we),
    .wd     (cfg_flush_fifo_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.cfg.flush_fifo.q ),

    // to register interface (read)
    .qs     (cfg_flush_fifo_qs)
  );
  ...
  assign cfg_flush_fifo_we = addr_hit[2] & reg_we & !reg_error;
  assign cfg_flush_fifo_wd = reg_wdata[3];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[2]: begin
        ...
        reg_rdata_next[3] = cfg_flush_fifo_qs;
