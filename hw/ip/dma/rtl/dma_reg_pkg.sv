...
package dma_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    dma_reg2hw_src_ptr_reg_t src_ptr; // [287:256]
    dma_reg2hw_dst_ptr_reg_t dst_ptr; // [255:224]
    dma_reg2hw_addr_ptr_reg_t addr_ptr; // [223:192]
    dma_reg2hw_size_d1_reg_t size_d1; // [191:175]
    dma_reg2hw_size_d2_reg_t size_d2; // [174:158]
    dma_reg2hw_status_reg_t status; // [157:154]
    dma_reg2hw_src_ptr_inc_d1_reg_t src_ptr_inc_d1; // [153:148]
    dma_reg2hw_src_ptr_inc_d2_reg_t src_ptr_inc_d2; // [147:125]
    dma_reg2hw_dst_ptr_inc_d1_reg_t dst_ptr_inc_d1; // [124:119]
    dma_reg2hw_dst_ptr_inc_d2_reg_t dst_ptr_inc_d2; // [118:96]
    dma_reg2hw_slot_reg_t slot; // [95:64]
    dma_reg2hw_src_data_type_reg_t src_data_type; // [63:62]
    dma_reg2hw_dst_data_type_reg_t dst_data_type; // [61:60]
    dma_reg2hw_sign_ext_reg_t sign_ext; // [59:59]
    dma_reg2hw_mode_reg_t mode; // [58:57]
    dma_reg2hw_dim_config_reg_t dim_config; // [56:56]
    dma_reg2hw_dim_inv_reg_t dim_inv; // [55:55]
    dma_reg2hw_pad_top_reg_t pad_top; // [54:48]
    dma_reg2hw_pad_bottom_reg_t pad_bottom; // [47:41]
    dma_reg2hw_pad_right_reg_t pad_right; // [40:34]
    dma_reg2hw_pad_left_reg_t pad_left; // [33:27]
  ...
  parameter logic [BlockAw-1:0] DMA_DIM_CONFIG_OFFSET = 7'h 3c;
  parameter logic [BlockAw-1:0] DMA_DIM_INV_OFFSET = 7'h 40;
  parameter logic [BlockAw-1:0] DMA_PAD_TOP_OFFSET = 7'h 44;
  parameter logic [BlockAw-1:0] DMA_PAD_BOTTOM_OFFSET = 7'h 48;
  parameter logic [BlockAw-1:0] DMA_PAD_RIGHT_OFFSET = 7'h 4c;
  parameter logic [BlockAw-1:0] DMA_PAD_LEFT_OFFSET = 7'h 50;
  parameter logic [BlockAw-1:0] DMA_WINDOW_SIZE_OFFSET = 7'h 54;
  parameter logic [BlockAw-1:0] DMA_WINDOW_COUNT_OFFSET = 7'h 58;
  parameter logic [BlockAw-1:0] DMA_INTERRUPT_EN_OFFSET = 7'h 5c;
  parameter logic [BlockAw-1:0] DMA_TRANSACTION_IFR_OFFSET = 7'h 60;
  parameter logic [BlockAw-1:0] DMA_WINDOW_IFR_OFFSET = 7'h 64;
  ...
  parameter logic [3:0] DMA_PERMIT [26] = '{
    ...
    4'b 0001, // index[15] DMA_DIM_CONFIG
    4'b 0001, // index[16] DMA_DIM_INV
    4'b 0001, // index[17] DMA_PAD_TOP
    4'b 0001, // index[18] DMA_PAD_BOTTOM
    4'b 0001, // index[19] DMA_PAD_RIGHT
    4'b 0001, // index[20] DMA_PAD_LEFT
    4'b 0011, // index[21] DMA_WINDOW_SIZE
    4'b 0001, // index[22] DMA_WINDOW_COUNT
    4'b 0001, // index[23] DMA_INTERRUPT_EN
    4'b 0001, // index[24] DMA_TRANSACTION_IFR
    4'b 0001  // index[25] DMA_WINDOW_IFR
  };
