...
module dma_reg_top #(
  ...
  logic dst_ptr_we;
  logic [31:0] addr_bcst_ptr_qs;
  logic [31:0] addr_bcst_ptr_wd;
  logic addr_bcst_ptr_we;
  logic [31:0] size_qs;
  logic [31:0] size_wd;
  logic size_we;
  ...
  always_comb begin
    ...
    addr_hit[2] = (reg_addr == DMA_ADDR_BCST_PTR_OFFSET);
    ...
    addr_hit[9] = (reg_addr == DMA_MODE_OFFSET);
    addr_hit[10] = (reg_addr == DMA_WINDOW_SIZE_OFFSET);
    addr_hit[11] = (reg_addr == DMA_WINDOW_COUNT_OFFSET);
    addr_hit[12] = (reg_addr == DMA_INTERRUPT_EN_OFFSET);
  end
  ...
  assign addr_bcst_ptr_we = addr_hit[2] & reg_we & !reg_error;
  assign addr_bcst_ptr_wd = reg_wdata[31:0];
  ...
  assign ptr_inc_bcst_ptr_inc_we = addr_hit[5] & reg_we & !reg_error;
  ...
  assign bslot_bx_trigger_slot_we = addr_hit[7] & reg_we & !reg_error;
  assign bslot_bx_trigger_slot_wd = reg_wdata[15:0];

  assign bslot_dx_trigger_slot_we = addr_hit[7] & reg_we & !reg_error;
  ...
  assign mode_we = addr_hit[9] & reg_we & !reg_error;
  assign mode_wd = reg_wdata[1:0];

  assign window_size_we = addr_hit[10] & reg_we & !reg_error;
  assign window_size_wd = reg_wdata[31:0];

  assign interrupt_en_transaction_done_we = addr_hit[12] & reg_we & !reg_error;
  assign interrupt_en_transaction_done_wd = reg_wdata[0];

  assign interrupt_en_window_done_we = addr_hit[12] & reg_we & !reg_error;
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[2]: begin
        reg_rdata_next[31:0] = addr_bcst_ptr_qs;
      end
