...
package pdm2pcm_reg_pkg;
  ...
  parameter logic [BlockAw-1:0] PDM2PCM_HB2COEF00_OFFSET = 8'h 2c;
  parameter logic [BlockAw-1:0] PDM2PCM_HB2COEF01_OFFSET = 8'h 30;
  parameter logic [BlockAw-1:0] PDM2PCM_HB2COEF02_OFFSET = 8'h 34;
  parameter logic [BlockAw-1:0] PDM2PCM_HB2COEF03_OFFSET = 8'h 38;
  parameter logic [BlockAw-1:0] PDM2PCM_HB2COEF04_OFFSET = 8'h 3c;
  parameter logic [BlockAw-1:0] PDM2PCM_HB2COEF05_OFFSET = 8'h 40;
  parameter logic [BlockAw-1:0] PDM2PCM_HB2COEF06_OFFSET = 8'h 44;
  parameter logic [BlockAw-1:0] PDM2PCM_FIRCOEF00_OFFSET = 8'h 48;
  parameter logic [BlockAw-1:0] PDM2PCM_FIRCOEF01_OFFSET = 8'h 4c;
  parameter logic [BlockAw-1:0] PDM2PCM_FIRCOEF02_OFFSET = 8'h 50;
  parameter logic [BlockAw-1:0] PDM2PCM_FIRCOEF03_OFFSET = 8'h 54;
  parameter logic [BlockAw-1:0] PDM2PCM_FIRCOEF04_OFFSET = 8'h 58;
  parameter logic [BlockAw-1:0] PDM2PCM_FIRCOEF05_OFFSET = 8'h 5c;
  parameter logic [BlockAw-1:0] PDM2PCM_FIRCOEF06_OFFSET = 8'h 60;
  parameter logic [BlockAw-1:0] PDM2PCM_FIRCOEF07_OFFSET = 8'h 64;
  parameter logic [BlockAw-1:0] PDM2PCM_FIRCOEF08_OFFSET = 8'h 68;
  parameter logic [BlockAw-1:0] PDM2PCM_FIRCOEF09_OFFSET = 8'h 6c;
  parameter logic [BlockAw-1:0] PDM2PCM_FIRCOEF10_OFFSET = 8'h 70;
  parameter logic [BlockAw-1:0] PDM2PCM_FIRCOEF11_OFFSET = 8'h 74;
  parameter logic [BlockAw-1:0] PDM2PCM_FIRCOEF12_OFFSET = 8'h 78;
  parameter logic [BlockAw-1:0] PDM2PCM_FIRCOEF13_OFFSET = 8'h 7c;

  // Window parameters
  parameter logic [BlockAw-1:0] PDM2PCM_RXDATA_OFFSET = 8'h 80;
  ...
  parameter logic [3:0] PDM2PCM_PERMIT [32] = '{
    ...
    4'b 0111, // index[ 7] PDM2PCM_HB1COEF00
    4'b 0111, // index[ 8] PDM2PCM_HB1COEF01
    4'b 0111, // index[ 9] PDM2PCM_HB1COEF02
    4'b 0111, // index[10] PDM2PCM_HB1COEF03
    4'b 0111, // index[11] PDM2PCM_HB2COEF00
    4'b 0111, // index[12] PDM2PCM_HB2COEF01
    4'b 0111, // index[13] PDM2PCM_HB2COEF02
    4'b 0111, // index[14] PDM2PCM_HB2COEF03
    4'b 0111, // index[15] PDM2PCM_HB2COEF04
    4'b 0111, // index[16] PDM2PCM_HB2COEF05
    4'b 0111, // index[17] PDM2PCM_HB2COEF06
    4'b 0111, // index[18] PDM2PCM_FIRCOEF00
    4'b 0111, // index[19] PDM2PCM_FIRCOEF01
    4'b 0111, // index[20] PDM2PCM_FIRCOEF02
    4'b 0111, // index[21] PDM2PCM_FIRCOEF03
    4'b 0111, // index[22] PDM2PCM_FIRCOEF04
    4'b 0111, // index[23] PDM2PCM_FIRCOEF05
    4'b 0111, // index[24] PDM2PCM_FIRCOEF06
    4'b 0111, // index[25] PDM2PCM_FIRCOEF07
    4'b 0111, // index[26] PDM2PCM_FIRCOEF08
    4'b 0111, // index[27] PDM2PCM_FIRCOEF09
    4'b 0111, // index[28] PDM2PCM_FIRCOEF10
    4'b 0111, // index[29] PDM2PCM_FIRCOEF11
    4'b 0111, // index[30] PDM2PCM_FIRCOEF12
    4'b 0111  // index[31] PDM2PCM_FIRCOEF13
  };
