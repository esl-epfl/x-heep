...
package core_v_mini_mcu_pkg;
  ...
  localparam logic[31:0] EXT_PERIPHERAL_START_ADDRESS = 32'h${ext_peripheral_start_address};
  localparam logic[31:0] EXT_PERIPHERAL_SIZE = 32'h${ext_peripheral_size_address};
