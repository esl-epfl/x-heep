...
% endfor
  ...
  localparam logic[31:0] PDM2PCM_START_ADDRESS = PERIPHERAL_START_ADDRESS + 32'h${pdm2pcm_start_offset};
  localparam logic[31:0] PDM2PCM_SIZE = 32'h${pdm2pcm_size_address};
