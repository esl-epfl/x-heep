...
package core_v_mini_mcu_pkg;
  ...
  localparam logic[31:0] ON_OFF_PERIPH_START_ADDRESS = 32'h${on_off_periph_start_address};
  localparam logic[31:0] ON_OFF_PERIPH_SIZE = 32'h${on_off_periph_size_address};
  ...
  localparam logic[31:0] ALWAYS_ON_PERIPH_START_ADDRESS = 32'h${always_on_periph_start_address};
  localparam logic[31:0] ALWAYS_ON_PERIPH_SIZE = 32'h${always_on_periph_size_address};
  ...
  localparam logic[31:0] EXT_PERIPH_START_ADDRESS = ON_OFF_PERIPH_START_ADDRESS + 32'h${ext_periph_start_offset};
  ...
  localparam logic[31:0] PLIC_START_ADDRESS = ON_OFF_PERIPH_START_ADDRESS + 32'h${plic_start_offset};
  ...
  localparam logic[31:0] SPI_HOST_START_ADDRESS = ON_OFF_PERIPH_START_ADDRESS + 32'h${spi_host_start_offset};
  ...
  localparam logic[31:0] SPI_MEMIO_START_ADDRESS = ON_OFF_PERIPH_START_ADDRESS + 32'h${spi_memio_start_offset};
  ...
  localparam logic[31:0] BOOTROM_START_ADDRESS = ON_OFF_PERIPH_START_ADDRESS + 32'h${bootrom_start_offset};
  ...
  localparam logic[31:0] GPIO_START_ADDRESS = ON_OFF_PERIPH_START_ADDRESS + 32'h${gpio_start_offset};
  ...
  localparam logic[31:0] SOC_CTRL_START_ADDRESS = ALWAYS_ON_PERIPH_START_ADDRESS + 32'h${soc_ctrl_start_offset};
  ...
  localparam logic [31:0] RV_TIMER_START_ADDRESS = ALWAYS_ON_PERIPH_START_ADDRESS + 32'h${rv_timer_start_offset};
