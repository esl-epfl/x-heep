...
package core_v_mini_mcu_pkg;
  ...
  localparam logic[31:0] PLIC_PERIPH_START_ADDRESS = PERIPHERAL_START_ADDRESS + 32'h${plic_periph_start_offset};
  localparam logic[31:0] PLIC_PERIPH_SIZE = 32'h${plic_periph_size_address};
