...
package core_v_mini_mcu_pkg;
  ...
  localparam logic[31:0] SOC_CTRL_IDX_START_ADDRESS  = PERIPHERAL_START_ADDRESS + 32'h${soc_ctrl_start_offset};
  localparam logic[31:0] SOC_CTRL_IDX_SIZE           = 32'h${soc_ctrl_size_address};
