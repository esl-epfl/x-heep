...
class uart_rx_start_bit_filter_vseq extends uart_smoke_vseq;
  ...
  // when start bit is detected, design will check it again after 0.5 uart_xheep clock
  ...
  virtual task send_rx_byte(byte data);
    ...
    repeat ($urandom_range(10, 100)) begin
      // drive 0 for up to 0.4 uart_xheep clk and 1 for 0.8 clk. Design samples start bit (0) first,
