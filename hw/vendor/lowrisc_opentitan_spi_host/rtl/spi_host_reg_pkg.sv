...
package spi_host_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    spi_host_reg2hw_intr_state_reg_t intr_state; // [172:171]
    spi_host_reg2hw_intr_enable_reg_t intr_enable; // [170:169]
    spi_host_reg2hw_intr_test_reg_t intr_test; // [168:165]
    spi_host_reg2hw_alert_test_reg_t alert_test; // [164:163]
    spi_host_reg2hw_control_reg_t control; // [162:144]
    spi_host_reg2hw_configopts_mreg_t [1:0] configopts; // [143:82]
    spi_host_reg2hw_csid_reg_t csid; // [81:50]
    spi_host_reg2hw_command_reg_t command; // [49:17]
  ...
  parameter logic [28:0] SPI_HOST_COMMAND_RESVAL = 29'h 0;
  parameter logic [23:0] SPI_HOST_COMMAND_LEN_RESVAL = 24'h 0;
