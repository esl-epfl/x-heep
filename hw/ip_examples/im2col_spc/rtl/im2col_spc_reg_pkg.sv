...
package im2col_spc_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    im2col_spc_reg2hw_src_ptr_reg_t src_ptr; // [387:356]
    im2col_spc_reg2hw_dst_ptr_reg_t dst_ptr; // [355:324]
    im2col_spc_reg2hw_iw_reg_t iw; // [323:292]
    im2col_spc_reg2hw_ih_reg_t ih; // [291:260]
    im2col_spc_reg2hw_fw_reg_t fw; // [259:252]
    im2col_spc_reg2hw_fh_reg_t fh; // [251:244]
    im2col_spc_reg2hw_batch_reg_t batch; // [243:236]
    im2col_spc_reg2hw_num_ch_reg_t num_ch; // [235:227]
    im2col_spc_reg2hw_ch_col_reg_t ch_col; // [226:211]
    im2col_spc_reg2hw_n_patches_w_reg_t n_patches_w; // [210:195]
    im2col_spc_reg2hw_n_patches_h_reg_t n_patches_h; // [194:179]
    im2col_spc_reg2hw_adpt_pad_right_reg_t adpt_pad_right; // [178:147]
    im2col_spc_reg2hw_adpt_pad_bottom_reg_t adpt_pad_bottom; // [146:115]
    im2col_spc_reg2hw_strides_d1_reg_t strides_d1; // [114:107]
    im2col_spc_reg2hw_strides_d2_reg_t strides_d2; // [106:99]
  ...
  parameter logic [3:0] IM2COL_SPC_PERMIT [25] = '{
    ...
    4'b 0001, // index[13] IM2COL_SPC_STRIDES_D1
    4'b 0001, // index[14] IM2COL_SPC_STRIDES_D2
