...
package im2col_spc_reg_pkg;
  ...
  typedef struct packed {
    logic [3:0]  q;
  } im2col_spc_reg2hw_log_strides_d1_reg_t;

  typedef struct packed {
    logic [3:0]  q;
  } im2col_spc_reg2hw_log_strides_d2_reg_t;
  ...
  typedef struct packed {
    logic [31:0] q;
  } im2col_spc_reg2hw_spc_ch_mask_reg_t;
  ...
  typedef struct packed {
    ...
    im2col_spc_reg2hw_iw_reg_t iw; // [267:236]
    im2col_spc_reg2hw_ih_reg_t ih; // [235:204]
    im2col_spc_reg2hw_fw_reg_t fw; // [203:196]
    im2col_spc_reg2hw_fh_reg_t fh; // [195:188]
    im2col_spc_reg2hw_batch_reg_t batch; // [187:180]
    im2col_spc_reg2hw_num_ch_reg_t num_ch; // [179:171]
    im2col_spc_reg2hw_ch_col_reg_t ch_col; // [170:155]
    im2col_spc_reg2hw_n_patches_w_reg_t n_patches_w; // [154:139]
    im2col_spc_reg2hw_n_patches_h_reg_t n_patches_h; // [138:123]
    im2col_spc_reg2hw_adpt_pad_right_reg_t adpt_pad_right; // [122:115]
    im2col_spc_reg2hw_adpt_pad_bottom_reg_t adpt_pad_bottom; // [114:107]
    im2col_spc_reg2hw_log_strides_d1_reg_t log_strides_d1; // [106:103]
    im2col_spc_reg2hw_log_strides_d2_reg_t log_strides_d2; // [102:99]
  ...
  parameter logic [BlockAw-1:0] IM2COL_SPC_LOG_STRIDES_D1_OFFSET = 7'h 34;
  parameter logic [BlockAw-1:0] IM2COL_SPC_LOG_STRIDES_D2_OFFSET = 7'h 38;
  ...
  parameter logic [BlockAw-1:0] IM2COL_SPC_SPC_CH_MASK_OFFSET = 7'h 60;
  ...
  parameter logic [3:0] IM2COL_SPC_PERMIT [25] = '{
    ...
    4'b 0001, // index[ 7] IM2COL_SPC_NUM_CH
    4'b 0011, // index[ 8] IM2COL_SPC_CH_COL
    4'b 0011, // index[ 9] IM2COL_SPC_N_PATCHES_W
    4'b 0011, // index[10] IM2COL_SPC_N_PATCHES_H
    4'b 0001, // index[11] IM2COL_SPC_ADPT_PAD_RIGHT
    4'b 0001, // index[12] IM2COL_SPC_ADPT_PAD_BOTTOM
    4'b 0001, // index[13] IM2COL_SPC_LOG_STRIDES_D1
    4'b 0001, // index[14] IM2COL_SPC_LOG_STRIDES_D2
    ...
    4'b 1111  // index[24] IM2COL_SPC_SPC_CH_MASK
  };
