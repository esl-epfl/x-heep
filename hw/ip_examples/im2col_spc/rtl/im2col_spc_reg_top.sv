...
module im2col_spc_reg_top #(
  ...
  logic [7:0] strides_d1_qs;
  logic [7:0] strides_d1_wd;
  logic strides_d1_we;
  logic [7:0] strides_d2_qs;
  logic [7:0] strides_d2_wd;
  logic strides_d2_we;
  logic status_qs;
  logic status_re;
  ...
  assign strides_d1_wd = reg_wdata[7:0];

  assign strides_d2_we = addr_hit[14] & reg_we & !reg_error;
  assign strides_d2_wd = reg_wdata[7:0];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[13]: begin
        reg_rdata_next[7:0] = strides_d1_qs;
      end

      addr_hit[14]: begin
        reg_rdata_next[7:0] = strides_d2_qs;
      end
