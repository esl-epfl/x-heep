...
mcu-gen:
	...
	python util/mcu_gen.py --cfg mcu_cfg.hjson --outdir sw/device/lib/drivers/power_manager --memorybanks $(MEMORY_BANKS) --pkg-sv sw/device/lib/drivers/power_manager/data/power_manager.h.tpl
	python util/mcu_gen.py --cfg mcu_cfg.hjson --outdir hw/ip/pad_control/data --pkg-sv hw/ip/pad_control/data/pad_control.hjson.tpl
	python util/mcu_gen.py --cfg mcu_cfg.hjson --outdir hw/ip/pad_control/rtl --pkg-sv hw/ip/pad_control/rtl/pad_control.sv.tpl
	bash -c "cd hw/ip/pad_control; source pad_control_gen.sh; cd ../../../"
