...
# Generates mcu files
mcu-gen:
	python util/mcu_gen.py --cfg mcu_cfg.hjson --outdir hw/core-v-mini-mcu/include --cpu $(CPU) --bus $(BUS) --memorybanks $(MEMORY_BANKS) --external_domains $(EXTERNAL_DOMAINS) --retentive_external_ram_banks $(RETENTIVE_EXTERNAL_RAM_BANKS) --pkg-sv hw/core-v-mini-mcu/include/core_v_mini_mcu_pkg.sv.tpl
	...
	python util/mcu_gen.py --cfg mcu_cfg.hjson --outdir hw/ip/power_manager/rtl --memorybanks $(MEMORY_BANKS) --external_domains $(EXTERNAL_DOMAINS) --retentive_external_ram_banks $(RETENTIVE_EXTERNAL_RAM_BANKS) --pkg-sv hw/ip/power_manager/data/power_manager.sv.tpl
	python util/mcu_gen.py --cfg mcu_cfg.hjson --outdir hw/ip/power_manager/data --memorybanks $(MEMORY_BANKS) --external_domains $(EXTERNAL_DOMAINS) --retentive_external_ram_banks $(RETENTIVE_EXTERNAL_RAM_BANKS) --pkg-sv hw/ip/power_manager/data/power_manager.hjson.tpl
